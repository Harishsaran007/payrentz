    ...
    <div className='max-w-[1301px] mx-auto'>
        <div className='flex flex-row gap-[30px] my-[20px] overflow-x-auto whitespace-nowrap scrollbar-hide px-[20px]'>
                ...
                <Link href='/appliances/refrigerator-on-rent' className='flex flex-col items-center shrink-0 cursor-pointer'>
                    ...
                    <p className='text-xs sm:text-sm font-bold text-[#ED1F28] mt-[16px]'>Refrigerators</p>
                </Link>
            ...
            <div className='mb-[20px] mx-[20px]'>
                <Card className="relative mr-[40px]  w-full max-w-sm pt-0 border-none shadow-none hover:border hover:border-gray-200 hover:shadow-md">
                    <img
                        src="/card2.png"
