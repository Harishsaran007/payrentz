...
const LaptopProductView = () => {
    ...
    const handleCheckAvailability = () => {
        ...
        const city = Object.entries(cityPinMap).find(([_, pin]) => pin === pinInput);
        if (city) {
            ...
            <div className='order-2 lg:row-span-2 lg:col-start-2 lg:row-start-1 lg:sticky lg:top-[-45px] h-fit'>
                ...
                <div className='py-[30px] flex flex-col px-[10px]'>
                    ...
                    <div className='flex items-center gap-[10px] pt-[10px]'>
                        <input type="text" placeholder='600001' className='border border-gray-300 font-medium text-base text-gray-400 max-w-[245px] w-full rounded-[5px] pl-[5px] h-[41px]' value={pinInput} onChange={handlePinChange} />
                        <Button variant='outline' className='border-black text-black text-base font-bold border-[1px] h-[41px]' disabled={pinInput.length !== 6} onClick={handleCheckAvailability}>Check availability</Button>
                        {productAvailable ? <p className='text-green-500 font-bold text-sm'>Product available!</p> : ''}
                    </div>
                </div>
...
export default LaptopProductView
